...
|-----|-----|-----|
|200|OK|服务器已成功处理请求|
|201|Created 【已创建】|对那些要服务器创建对象的请求来说，资源已创建完毕。通常这是 PUT 方法得到的响应码。|
|202|Accepted 【已接受】|请求已接受，但服务器尚未处理|
|203|Non-Authoritative Information 【非权威信息】|实体首部包含的信息不是来自源端服务器，而是来自资源的一份副本|
|204|No Content 【没有内容】|响应报文包含一些首部和一个状态行，但不包含实体的主体内容|
|205|Reset Content 【重置内容】|浏览器应该重置当前页面上所有的HTML表单|
|206|Partial Content【部分内容】|成功执行了一个部分或Range（范围）请求|
